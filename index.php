        ...
        <div class="contenido p_empezar">
            <div class="cont_contenido">
                ...
                <form onsubmit="return send()" action="http://35.185.64.95/ajax/index.php" method="post">
                    ...
                    <div class="input">
                        <input type="text" name="dominio" placeholder="www.tusitio.cl" <?php if($_GET["realizado"] == 0 && $_GET["tipo"] == 1){ echo "style='border: 3px solid #c66'"; } ?> />
                    </div>
                    <h3>Ingresa tu Correo</h3>
                    <div class="input">
                        <input type="text" name="correo" placeholder="tucorreo@gmail.com" <?php if($_GET["realizado"] == 0 && $_GET["tipo"] == 2){ echo "style='border: 3px solid #c66'"; } ?> />
                    </div>
                    <h6>reCAPTCHA</h6>
